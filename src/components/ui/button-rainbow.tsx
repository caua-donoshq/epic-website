  ...
  return (
    <button
      className={cn(
        ...
        // light mode colors
        "bg-[linear-gradient(#FF6900,#FF6900),linear-gradient(#FF6900_50%,rgba(255,105,0,0.6)_80%,rgba(255,105,0,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
