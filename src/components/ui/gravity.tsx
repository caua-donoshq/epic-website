    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        if (props.bodyType === "circle") {
          ...
          if ('chamfer' in circleOptions && circleOptions.chamfer === null) {
            delete circleOptions.chamfer
          }
          body = Bodies.circle(x, y, radius, circleOptions)
          ...
          if ('chamfer' in bodyOptions && bodyOptions.chamfer === null) {
          ...
          if ('chamfer' in rectOptions && rectOptions.chamfer === null) {
            delete rectOptions.chamfer
          }
          body = Bodies.rectangle(x, y, width, height, rectOptions)
        }
    ...
    const initializeRenderer = useCallback(() => {
      ...
      if (typeof window !== 'undefined') {
        import('poly-decomp').then((decomp) => {
          // @ts-expect-error poly-decomp module may not have proper TypeScript definitions
